...
import { AnimatedBackground } from '../editors/NewTextTypingEditor/assets/Backgrounds';
import { DEFAULT_SETTINGS, BACKGROUNDS, FONTS, AUDIO_FILES } from '../editors/NewTextTypingEditor/assets/configs';
