...
interface KpiFlipCardsBatchRenderingInidicatorInterface {
  isRendering: boolean;
  renderQueue: number[];
  currentIndex: number | null;
  setShowProgressCard: React.Dispatch<React.SetStateAction<boolean>>;
  setActiveSection: React.Dispatch<
    React.SetStateAction<  "dataset" | "backgrounds" | "fonts" | "colors" | "outputs">
  >;
}

export const KpiFlipCardsBatchRenderingInidicator: React.FC<
  KpiFlipCardsBatchRenderingInidicatorInterface
> = ({
  isRendering,
  renderQueue,
  currentIndex,
