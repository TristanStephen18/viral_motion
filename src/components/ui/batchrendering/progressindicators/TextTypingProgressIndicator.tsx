...
interface TexttTypingBatchRenderingInidicatorInterface {
  isRendering: boolean;
  renderQueue: number[];
  currentIndex: number | null;
  setShowProgressCard: React.Dispatch<React.SetStateAction<boolean>>;
  setActiveSection: React.Dispatch<
    React.SetStateAction< "dataset" | "backgrounds" | "fonts" | "sound" | "outputs">
  >;
}

export const TexttTypingBatchRenderingInidicator: React.FC<
  TexttTypingBatchRenderingInidicatorInterface
> = ({
  isRendering,
  renderQueue,
  currentIndex,
