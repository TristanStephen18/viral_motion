...
interface FactCardsBatchRenderingInidicatorInterface {
  isRendering: boolean;
  renderQueue: number[];
  currentIndex: number | null;
  setShowProgressCard: React.Dispatch<React.SetStateAction<boolean>>;
  setActiveSection: React.Dispatch<
    React.SetStateAction<"dataset" | "animation" | "backgrounds" | "fonts" | "colors" | "outputs">
  >;
}

export const FactCardsBatchRenderingInidicator: React.FC<
  FactCardsBatchRenderingInidicatorInterface
> = ({
  isRendering,
  renderQueue,
  currentIndex,
