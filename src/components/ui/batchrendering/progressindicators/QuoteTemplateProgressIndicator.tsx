...
interface QouteTemplateBatchRenderingInidicatorInterface {
  isRendering: boolean;
  renderQueue: number[];
  currentIndex: number | null;
  setShowProgressCard: React.Dispatch<React.SetStateAction<boolean>>;
  setActiveSection: React.Dispatch<
    React.SetStateAction<"dataset" | "backgrounds" | "fonts" | "outputs" | "fontcolors">
  >;
}

export const QouteTemplateBatchRenderingInidicator: React.FC<
  QouteTemplateBatchRenderingInidicatorInterface
> = ({
  isRendering,
  renderQueue,
  currentIndex,
