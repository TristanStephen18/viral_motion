...
interface CurveLineTrendBatchRenderingInidicatorInterface {
  isRendering: boolean;
  renderQueue: number[];
  currentIndex: number | null;
  setShowProgressCard: React.Dispatch<React.SetStateAction<boolean>>;
  setActiveSection: React.Dispatch<
    React.SetStateAction< "dataset" | "presets" | "fonts" | "animation" | "outputs">
  >;
}

export const CurveLineTrendBatchRenderingInidicator: React.FC<
  CurveLineTrendBatchRenderingInidicatorInterface
> = ({
  isRendering,
  renderQueue,
  currentIndex,
