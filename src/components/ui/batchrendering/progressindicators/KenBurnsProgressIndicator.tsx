...
interface KenburnsBatchRenderingInidicatorInterface {
  isRendering: boolean;
  renderQueue: number[];
  currentIndex: number | null;
  setShowProgressCard: React.Dispatch<React.SetStateAction<boolean>>;
  setActiveSection: React.Dispatch<
    React.SetStateAction<"images" | "quantity" | "proportions" | "outputs">
  >;
}

export const KenburnsBatchRenderingInidicator: React.FC<
  KenburnsBatchRenderingInidicatorInterface
> = ({
  isRendering,
  renderQueue,
  currentIndex,
