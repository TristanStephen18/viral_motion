...
interface KpiFlipCardsBatchOutputProps {
  isRendering: boolean;
  combinations: any[];
}

export const KpiFlipCardsBatchOutputs: React.FC<
  KpiFlipCardsBatchOutputProps
> = ({ combinations, isRendering }) => {
  return (
    <Box>
      <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
        ...
        {!isRendering && combinations.some((c) => c.exportUrl) && (
          <Button
            ...
            onClick={() => {
              handleDownloadAll(combinations, "kpiflipcards")
            }}
          >
            Download All
          </Button>
