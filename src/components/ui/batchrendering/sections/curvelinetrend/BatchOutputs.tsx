...
interface CurveLineTrendOutputsSectionInterface {
  isRendering: boolean;
  combinations: any[];
}

export const CurveLineTrendOutputsSection: React.FC<
  CurveLineTrendOutputsSectionInterface
      ...
      <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
        ...
        {!isRendering && combinations.some((c) => c.exportUrl) && (
          <Button
            ...
            onClick={() => {
              handleDownloadAll(combinations, "curvelinetrend")
            }}
          >
            Download All
          </Button>
