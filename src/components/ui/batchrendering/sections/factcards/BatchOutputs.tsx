...
interface FactCardsOutputsSectionInterface {
  isRendering: boolean;
  combinations: any[];
}

export const FactCardsOutputsSection: React.FC<
  FactCardsOutputsSectionInterface
      ...
      <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
        ...
        {!isRendering && combinations.some((c) => c.exportUrl) && (
          <Button
            ...
            onClick={() => {
              handleDownloadAll(combinations, "factcards")
            }}
          >
            Download All
          </Button>
          ...
          {combinations.map((c, i) => (
            ...
            >
              ...
              <Box sx={{ mt: 0.5, textAlign: "center" }}>
                ...
                >
                  Font: {c.font} | Color: {c.fontColor} | Pacing: {c.pacing}
                </Typography>
              </Box>
            </Box>
          ))}
