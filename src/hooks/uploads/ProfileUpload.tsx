...
export function useProfileFileUpload(
  ...
  const {
    uploadUrl = `https://remotion-backend-b2vw.onrender.com/uploadhandler/upload-image`,
    fieldName = "image",
    saveRecord = true,
    recordUrl = `https://remotion-backend-b2vw.onrender.com/auth/update-profile-picture`,
    type,
  } = options;
